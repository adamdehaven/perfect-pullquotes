...
Description: A Wordpress theme plugin to add left or right-aligned pullquotes. Also includes two custom buttons for the TinyMCE Editor
Author: Adam Dehaven
Version: 1.0
...
function adamdehaven_add_buttons($plugin_array) {
	$plugin_array['adamdehaven'] = get_template_directory_uri() . '/perfect-pullquotes/pullquote-shortcode.js';
	return $plugin_array;
}
